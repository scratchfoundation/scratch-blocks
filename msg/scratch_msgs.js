...
ScratchMsgs.locales['af'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    '\'n Veranderlike met die naam "%1" bestaan reeds vir \'n ander veranderlike van tipe "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Skrap %1 gebruike van die "%2" veranderlike?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Kan nie die veranderlike "%1" skrap nie want dit is deel van die definisie van die funksie "%2"',
...
ScratchMsgs.locales['an'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'No se puede borrar la variable "%1" perque ye parte d\'a definición d\'a función "%2"',
...
ScratchMsgs.locales['ast'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Nun se pue esborrar la variable "%1" porque ye parte de la definición de la función "%2"',
...
ScratchMsgs.locales['bn'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    '"%1" নামক একটি ভ্যারিয়েবল ইতিমধ্যে "%2" ধরনের অন্য একটি ভ্যারিয়েবল এর জন্য বিদ্যমান।',
...
ScratchMsgs.locales['bg'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Не може да се изтрие променливата "%1", защото участва в дефиницията на функцията "%2".',
...
ScratchMsgs.locales['ca'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Ja existeix una variable anomenada "%1" per una altra variable de tipus "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Eliminar els %1 usos de la variable "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'No es pot eliminar la variable "%1" perquè forma part de la definició de la funció "%2"',
...
ScratchMsgs.locales['cy'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Mae newidyn o\'r enw "%1" yn bodoli eisoes ar gyfer math arall o newidyn "%2".',
...
ScratchMsgs.locales['da'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Der eksisterer allerede en variabel med navnet "%1"  for en anden variabel af typen "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Slet %1 brugen af denne "%2" variabel?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Kan ikke slette variablen "%1" fordi at den er en del af forklaringen til funktionen "%2"',
...
ScratchMsgs.locales['de'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Eine Variable mit dem Namen "%1" existiert bereits als Variable des Typs "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Entferne alle %1 Nutzungen der Variable "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Die Variable "%1" kann nicht gelöscht werden, weil sie Teil der Definition der Funktion "%2" ist.',
  ...
  PROCEDURE_USED:
    'Bevor die Blockdefinition gelöscht werden kann, muss der Block zuerst aus allen Skripten entfernt werden, in denen er verwendet wird',
  NEW_LIST: 'Neue Liste',
...
ScratchMsgs.locales['et'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Muutujat "%1" ei saa eemaldada, sest see on osa funktsiooni "%2" definitsioonist.',
...
ScratchMsgs.locales['el'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Υπάρχει ήδη μια μεταβλητή με όνομα "%1" για μια άλλη μεταβλητή τύπου "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Διαγραφή %1 χρήσεων της μεταβλητής "%2";',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Η μεταβλητή "%1" δεν μπορεί να διαγραφεί γιατί είναι μέρος του ορισμού της λειτουργίας "%2"',
...
ScratchMsgs.locales['eu'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Ezin da "%1" aldagaia ezabatu "%2" funtzioaren definizioan parte hartzen duelako.',
...
ScratchMsgs.locales['fa'] = {
  ...
  CONTROL_STOP_OTHER: 'سایر برنامه‌های این شکلک',
...
ScratchMsgs.locales['fil'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Meron na\'ng variable na "%1" para sa ibang variable na may type na "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Tanggalin ang %1 (na) paggamit ng "%2" na variable?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Di mabura ang variable na "%1" dahil parte ito ng kahulugan para sa function na "%2"',
  ...
  PROCEDURE_USED:
    'Para burahin ang kahulugan ng isang block, tanggalin muna ang lahat ng paggamit sa naturang block.',
...
ScratchMsgs.locales['fr'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Une variable nommée "%1" existe déjà pour une autre variable de type "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Supprimer %1 utilisations de la variable "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Impossible de supprimer la variable "%1" car elle fait partie de la définition de la fonction "%2"',
...
ScratchMsgs.locales['fy'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'In fariabele mei de namme "%1" bestiet al foar in oare fariabele fan it type "%2".',
  DELETE_VARIABLE_CONFIRMATION: '%1 ynstânsjes fan de fariabele "%2" fuortsmite?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Kin de fariabele "%1" net wiskje, om\'t it diel is fan \'e definysje fan\' e funksje "%2"',
...
ScratchMsgs.locales['ga'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Ní féidir athróg "%1" a scriosadh toisc gur cuid den sainmhíniú ar fheidhm "%2" í.',
...
ScratchMsgs.locales['gl'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Non é posíbel eliminar a variábel «%1» porque é parte da definición da función «%2».',
...
ScratchMsgs.locales['ha'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'tuni akwai abu mai canzawa mai suna "%1" ga wani abu mai canzawa irin "%2"',
  DELETE_VARIABLE_CONFIRMATION: 'goge amfanonin %1 na daga abu mai canzawan "%2" ',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Ba za a iya goge abu mai canzawan "%1" ba saboda yana wani bangare na aikin "%2"',
...
ScratchMsgs.locales['hy'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Հնարավոր չէ ջնջել «%1» փոփոխականը, քանի որ այն «%2» ֆունկցիայի սահմանման մասն է:',
...
ScratchMsgs.locales['hi'] = {
  ...
  EVENT_WHENSTAGECLICKED: 'जब पड़ाव क्लिक किए गए',
  ...
  MOTION_STAGE_SELECTED: 'चुनिंदा पड़ाव: कोई गति खंड नहीं',
  OPERATORS_ADD: '%1 + %2',
  OPERATORS_SUBTRACT: '%1 - %2',
  OPERATORS_MULTIPLY: '%1 * %2',
  OPERATORS_DIVIDE: '%1 / %2',
...
ScratchMsgs.locales['is'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Það er nú þegar til breyta sem heitir "%1" fyrir aðra breytu af týpunni "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Þú ert að nota "%2" á %1 stöðum. Viltu samt eyða breytunni?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Þú getur ekki eytt breytunni "%1" vegna þess að þú ert að nota hana í kubb af eigin hönnun. Hann heitir: "%2".',
...
ScratchMsgs.locales['it'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    "Una variabile chiamata \"%1\" già esiste per un'altra variabile di tipo '%2'.",
  DELETE_VARIABLE_CONFIRMATION: 'Eliminare tutti i %1 riferimenti alla variabile "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Non è possibile eliminare la variabile "%1" perchè fa parte della definizione della funzione "%2"',
  ...
  PROCEDURE_USED:
    'Per rimuovere la definizione di un blocco è prima necessario rimuovere tutti i punti in cui il blocco viene usato',
...
ScratchMsgs.locales['ka'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'შეუძლებელია ცვლადი "%1"-ის წაშლა რადგან ის არის "%2"-ის ფუნქციის განსაზღვრის ნაწილი ',
...
ScratchMsgs.locales['sw'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Kibadilika kinachoitwa "%1" tayari ipo kwa kibadilika kingine chenye aina ya "%2".',
...
ScratchMsgs.locales['ht'] = {
  ...
  EVENT_WHENKEYPRESSED_LEFT: 'flèch goch',
  EVENT_WHENKEYPRESSED_RIGHT: 'flèch dwat',
  EVENT_WHENKEYPRESSED_DOWN: 'flèch an ba',
  EVENT_WHENKEYPRESSED_UP: 'flèch an wo',
  ...
  MOTION_POINTTOWARDS_POINTER: 'flèch souri a',
  MOTION_POINTTOWARDS_RANDOM: 'direksyon pa aza',
  MOTION_GOTO: 'ale nan %1',
  MOTION_GOTO_POINTER: 'flèch souri a',
  ...
  MOTION_GLIDETO_POINTER: 'flèch souri a',
  ...
  SENSING_TOUCHINGOBJECT_POINTER: 'flèch souri a',
  ...
  SENSING_DISTANCETO_POINTER: 'flèch souri ',
...
ScratchMsgs.locales['hu'] = {
  ...
  PROCEDURE_USED:
    'Az egyedi parancs definiáló blokkjának törléséhez előbb távolítsd el a blokk összes használatát a projektben.',
...
ScratchMsgs.locales['mi'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Kua hangaia kētia tētahi taurangi, ko "%1"  te ingoa, engari he momo "%2" tērā.',
  DELETE_VARIABLE_CONFIRMATION: 'Mukua hoki %1 ngā mahinga o te taurangi "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Kāore e taea te muku i te taurangi "%1", nā te mea he wāhanga taua taurangi o te tautuhinga mō te hātepe "%2"',
...
ScratchMsgs.locales['mn'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Хувьсагчийн "%1" нэр нь "%2" төрлийн өөр хувьсагчийн нэртэй давхцаж байна.',
...
ScratchMsgs.locales['nl'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    "Er bestaat al een variabele met de naam '%1' voor een andere variabele van het type '%2'",
  DELETE_VARIABLE_CONFIRMATION: "Verwijder de %1 toepassingen van de variabele '%2'?",
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    "Kan de variabele '%1' niet verwijderen, omdat die deel uitmaakt van de definitie van de functie '%2'",
...
ScratchMsgs.locales['nb'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Kan ikke slette variabelen "%1" fordi den brukes i definisjonen av funksjonen "%2"',
...
ScratchMsgs.locales['nn'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Det finst alt ein variabel som heiter «%1», for ein annan variabel av type «%2».',
  DELETE_VARIABLE_CONFIRMATION: 'Vil du sletta %1 bruk av variabelen «%2»?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Kan ikkje sletta variabelen «%1», då han er del av definisjonen til funksjonen «%2».',
  DELETE_VARIABLE: 'Slett variabelen «%1»',
...
ScratchMsgs.locales['oc'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Una variable nomenada « %1 » existís ja per una autra variabla de tipe « %2 ».',
  DELETE_VARIABLE_CONFIRMATION: 'Suprimir las utilizacions %1 de la variable « %2 »',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'La variabla %1 pòt pas èsser suprimida, que fa partida de la definicion de la foncion « %2 »',
...
ScratchMsgs.locales['uz'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    '"%2" ko\'rinish boshqa o\'zgaruvchida "%1" o\'zgaruvchida allaqachon mavjud',
  DELETE_VARIABLE_CONFIRMATION: '"%2" o\'zgaruvchisi uchun %1 ni o\'chirmoqchimisiz?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    '"%1" o\'zgaruvchisini o\'chirib bo\'lmaydi, chunki u "%2" funksiyasining bir qismi',
...
ScratchMsgs.locales['pt'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Não é possível remover a variável «%1» porque é parte da definição da função «%2»',
...
ScratchMsgs.locales['pt-br'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    "Não é possível apagar a variável '%1' pois ela faz parte da definição do bloco '%2'",
...
ScratchMsgs.locales['ro'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'O variabilă cu numele "%1" există deja pentru o altă variabilă de tip "%2".',
  DELETE_VARIABLE_CONFIRMATION: 'Șterge %1 utilizări ale variabilei "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Variabila cu numele "%1" nu poate fi ștearsă deoarece este parte a definiției funcției "%2". ',
...
ScratchMsgs.locales['ru'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Нельзя удалить переменную "%1", так как она является частью определения функции "%2"',
...
ScratchMsgs.locales['nso'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Phetošo yeo e bitšwago "%1" e šetše e le gona go phetošo e nngwe ya mohuta wa "%2"',
  DELETE_VARIABLE_CONFIRMATION: 'Phumula %1 ya tšhomišo phetošo ya "%2"',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'E ka se phumule phetošo "%1" ka lebaka la gore ke karolo ya hlaloso ya tšhomišo ya "%2"',
...
ScratchMsgs.locales['tn'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    'Pharologano e e bidiwang "%1" e setse e tlhageletse ka pharologano e nngwe ya mofuta wa "%2"',
  DELETE_VARIABLE_CONFIRMATION: 'Phimola %1 e e dirisang pharologano ya "%2"?',
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'O ka se phimole pharologano ya "%1" gonne ke karolo ya tlhaloso ya mosola wa "%2"',
...
ScratchMsgs.locales['fi'] = {
  ...
  VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE:
    '"%1"-niminen muuttuja on jo käytössä toisella "%2"-tyyppisellä muuttujalla.',
...
ScratchMsgs.locales['sv'] = {
  ...
  CANNOT_DELETE_VARIABLE_PROCEDURE:
    'Kan inte ta bort variabel "%1" för att den är en del av definitionen av funktionen "%2"',
