...
function test_findCallers_simple_oneCaller() {
  var xml =
    ...
    '<variables></variables>' +
    '<block type="' +
    Blockly.PROCEDURES_CALL_BLOCK_TYPE +
  ...
  try {
    ...
    var callers = Blockly.Procedures.getCallers('test_procedure', workspace, { id: '' }, false)
...
function test_findCallers_noRecursion() {
  ...
  try {
    ...
    var callers = Blockly.Procedures.getCallers('test_procedure', workspace, rootBlock, false /* allowRecursion */)
...
function test_findCallers_allowRecursion() {
  ...
  try {
    ...
    workspace.getBlockById('test_1').procCode_ = 'test_procedure'
    var rootBlock = workspace.getBlockById('test_1')
    var callers = Blockly.Procedures.getCallers('test_procedure', workspace, rootBlock, true /* allowRecursion */)
...
function test_deleteProcedure_noCallers() {
  ...
  try {
    ...
    workspace.getBlockById('test_1').procCode_ = 'test_procedure'
    var rootBlock = workspace.getBlockById('test_1')
    assertTrue(Blockly.Procedures.deleteProcedureDefCallback('test_procedure', rootBlock))
...
function test_deleteProcedure_nonRecursiveCaller() {
  ...
  try {
    ...
    assertFalse(Blockly.Procedures.deleteProcedureDefCallback('test_procedure', rootBlock))
