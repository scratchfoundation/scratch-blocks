...
export class BlockCommentNavigationPolicy implements Blockly.INavigationPolicy<ScratchCommentBubble> {
   ...
   * @param current The block comment bubble to return the first child of.
   ...
   * @returns True.
   */
  isNavigable(_current: ScratchCommentBubble): boolean {
    return true
  }
   ...
   */
  isApplicable(current: unknown): current is ScratchCommentBubble {
